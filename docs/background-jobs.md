...
### 5. Увеличение рейтинга фейковых пользователей

**Команда:** `fake-users:increase-rating`

**Расписание:** Каждые 4 часа (6 раз в день)

**Описание:**
- Увеличивает рейтинг всех фейковых пользователей на случайное значение от 0.01 до 0.02
- Имитирует активность фейковых пользователей (как будто они играли в мини-игры)
- Максимальный рейтинг для фейковых пользователей ограничен 15.0
- За день фейковый пользователь получает примерно 0.07-0.1 рейтинга (как будто играл 15-20 минут)

**Файл:** `app/Console/Commands/IncreaseFakeUsersRating.php`

**Особенности:**
- Без перекрытия (`withoutOverlapping()`)
- Обрабатывает только пользователей с `is_fake = true`
...
### Каждые 4 часа
- `fake-users:increase-rating` - Увеличение рейтинга фейковых пользователей (6 раз в день)
...
- `fake-users:increase-rating` независим и имитирует активность фейковых пользователей
