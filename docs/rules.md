...
**Важно:** Если игрок менял команду в течение сезона, чемпионство учитывается только за команду, в которой сыграно наибольшее количество матчей (подробнее см. раздел 6.1)
...
#### Определение чемпионства для игроков, менявших команды

- Если игрок в течение сезона играл за несколько команд, чемпионство учитывается только за ту команду, в которой игрок провел наибольшее количество матчей
- Это правило распространяется на всех игроков, включая тех, кто имеет премиум аккаунт и может менять команду неограниченное количество раз
- В случае равенства количества матчей за разные команды, чемпионство учитывается за команду, в составе которой игрок находился на момент завершения сезона
