...
<section class="bg-gray-900 py-16 relative overflow-hidden">
    <div class="absolute inset-0">
        <img src="/v1/images/tournaments-banner.jpg" alt="Friendly Matches Background" class="w-full h-full object-cover opacity-30">
    </div>
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 class="heading-font text-5xl md:text-7xl text-white mb-6">Товарищеские матчи</h1>
        <p class="text-xl text-gray-200 mb-8 max-w-3xl mx-auto">Все товарищеские игры между командами лиги.</p>
    </div>
</section>
...
<section class="py-8 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <form method="GET" action="/friendly-matches" id="filterForm" class="flex flex-col md:flex-row gap-4">
            <div class="flex-1">
            ...
            <div class="flex items-end">
                ...
                @if(request()->has('status') || request()->has('date'))
                    <a href="/friendly-matches" class="ml-2 bg-gray-200 text-gray-700 font-bold px-6 py-2 rounded-lg hover:bg-gray-300 transition-colors">
                        Сбросить
                    </a>
                @endif
            </div>
                    ...
                    <div class="mb-12">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            @foreach($matches as $match)
                                <a href="/friendly-matches/{{ $match->id }}" class="block">
