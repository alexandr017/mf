...
<section class="bg-gray-900 py-16 relative overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/tournaments" class="bg-primary hover:bg-opacity-80 text-gray-900 font-bold px-8 py-4 !rounded-button text-lg whitespace-nowrap cursor-pointer">
            ...
            <a href="/upcoming-games" class="bg-white hover:bg-gray-100 text-gray-900 font-bold px-8 py-4 !rounded-button text-lg whitespace-nowrap cursor-pointer">
                <div class="flex items-center gap-2">
                    <div class="w-6 h-6 flex items-center justify-center">
